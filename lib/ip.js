//Module to check IP restrictions. It reads a text file that has lines in this format:
//{IP/Mask}\t{comment}\t{timestamp}
//
//IP/Mask     - IP address with netmask to allow. For single IPs netmask is still required. Set it to /32 (or /128 for IPv6 address)
//comment     - Text that describes the IP. It is not evaluated
//timestamp   - Expiration of Entry. 0 means it never expires. This uses unix timestamps and not JS timestamps.
